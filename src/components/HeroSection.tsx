...
const HeroSection = () => {
  return (
    <section id="inicio" className="relative overflow-hidden bg-gradient-to-b from-pastel-pink/30 to-white pt-16 md:pt-20 lg:pt-24">
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight text-gray-900 mb-6">
              Descubra a <span className="text-primary">maternidade real</span> e a parentalidade
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-primary hover:bg-pastel-pink-dark text-primary-foreground font-medium rounded-full text-lg px-8 py-6">
                Agende sua Consulta
              </Button>
              <Button variant="outline" className="border-primary text-gray-700 hover:bg-pastel-pink/20 font-medium rounded-full text-lg px-8 py-6">
                Saiba mais
              </Button>
            </div>
          </div>
          <div className="relative animate-fade-in flex justify-center">
            ...
            <div className="absolute -bottom-4 -right-4 bg-pastel-pink p-6 rounded-xl shadow-lg max-w-[240px]">
