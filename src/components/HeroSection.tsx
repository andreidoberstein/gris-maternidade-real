...
const HeroSection = () => {
  return (
    <section id="inicio" className="relative overflow-hidden bg-gradient-to-b from-pastel-beige/70 to-white">
      <div className="m-auto max-w-[80rem] px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h1 className="text-4xl sm:text-5xl text-primary-foreground md:text-6xl font-bold leading-tight text-gray-900 mb-6">
              Transforme sua <span className="">jornada na </span>maternidade
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">   
              <a 
                ...
                className="inline-block bg-primary hover:bg-pastel-pink-dark text-primary-foreground font-medium rounded-full text-lg px-8 py-3 transition-colors duration-300"
                target='_blank'
              >
                Agende uma Consulta
              </a>    
