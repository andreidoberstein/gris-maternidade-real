...
const Footer = () => {
  ...
  return (
    <footer className="bg-pastel-gray/30 pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-700 font-medium">CRP: 06/123456</p>
          </div>
          
          <div>
            <h4 className="text-lg font-medium mb-4 text-gray-800">Links Rápidos</h4>
          ...
          <div>
            <h4 className="text-lg font-medium mb-4 text-gray-800">Horário de Atendimento</h4>
