      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Psicóloga especializada em maternidade, com a missão de tornar essa jornada mais tranquila e empoderada para todas as mulheres.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-pastel-yellow p-5 rounded-full shadow-lg">
          ...
          <div>
            <h3 className="text-2xl md:text-3xl font-bold mb-6 text-gray-800">Transformando a experiência materna</h3>
            <p className="text-gray-600 mb-8">
              Olá! Sou Gris, psicóloga com formação especializada no acolhimento de mulheres durante a jornada da maternidade. Acredito que este momento único merece um olhar sensível e técnico, que respeite as individualidades e ofereça suporte genuíno.
            </p>
            <p className="text-gray-600 mb-8">
              Meu trabalho é pautado na escuta empática e no desenvolvimento de estratégias personalizadas para ajudar mães a lidarem com os desafios deste período, promovendo autoconfiança e bem-estar emocional.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-10">
              <Card className="bg-pastel-yellow/20 border-pastel-yellow">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 text-sm">Abordagem única para cada mãe</p>
                </CardContent>
              </Card>
